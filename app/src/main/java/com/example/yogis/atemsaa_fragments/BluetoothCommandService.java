...
/**
 * Created by yogis on 19/05/2016.
 */
...
//    private int mConnectionLostCount;
    ...
    public static final int STATE_NONE = 0;       // no se est  haciendo nada
    public static final int STATE_LISTEN = 1;     // escuchando conexiones entrantes
    public static final int STATE_CONNECTING = 2; // iniciando una conexion de salida
            ...
            while (true) {
                try {
                    ...
                    if(bytes != -1){
                        ...
                        mHandler.obtainMessage(MainActivity.MESSAGE_READ, -1, -1, bufferRX)
                                .sendToTarget();
                    }
